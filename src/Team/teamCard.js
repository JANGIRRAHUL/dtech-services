function TeamCard({ eachTeam, i }) {
    ...
    return (<>
        <div className={`-mx-20 flex rounded-[20px] min-w-[260px] aspect-video  ${i == 0 ? 'card-right bg-[#e0e0ff]' : i >= 2 ? 'card-left bg-[#e0e0ff] z-0' : 'card-center bg-white z-10'} relative ease-in-out duration-500 snap-center`}>
